...
class Selector(ttk.Frame):
    ...
    def __init__(self, parent, command, tipus='R'):
        ...
        self.__rbR = Radiobutton(self, text='Romano', bg="lightgray", variable=self.value, value='R', command=lambda: command('R'))
        self.__rbA = Radiobutton(self, text='Arábigo', bg="lightgray", variable=self.value, value='A', command=lambda: command('A'))
